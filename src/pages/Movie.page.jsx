...
const Movie = () => {
    ...
    return (
        <>
            <MovieHero />
            <div className=" my-12 container px-4 lg:px-24">
                ...
                <div className="my-8">
                    ...
                    <div className="flex flex-col gap-3 lg:flex-row">
                        <div className="flex items-start gap-2 bg-yellow-100 px-3 py-3 border-2 border-yellow-400 border-dashed rounded-lg">
